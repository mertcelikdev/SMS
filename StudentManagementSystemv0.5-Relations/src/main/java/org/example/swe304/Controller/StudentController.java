...
public class StudentController {
    ...
    @ResponseBody
    public ResponseEntity<StudentDTO> addStudentJson(@Valid @RequestBody StudentDTO studentDTO, BindingResult result) {
        if (result.hasErrors()) {
    ...
    @ResponseBody
    public ResponseEntity<StudentDTO> updateStudentJson(@PathVariable Long id, @Valid @RequestBody StudentDTO studentDTO, BindingResult result) {
        if (result.hasErrors()) {
            return ResponseEntity.badRequest().build();
        }
